...
namespace CRUD.Interfaces
{
    public interface IGradeSubjectService
    {
        ...
        Task<ServiceResponse<PagedResult<GradeSubjectWithTeachersResponseDto>>> GetGradeSubjectsPagedAsync(PaginationParameters parameters);
        Task<ServiceResponse<PagedResult<GradeSubjectWithTeachersResponseDto>>> GetGradeSubjectsByGradeIdPagedAsync(int gradeId, PaginationParameters parameters);
    }
}
