...
namespace CRUD.Interfaces
{
    public interface IGradeSubjectRepository
    {
        ...
        Task<PagedResult<GradeSubjectWithTeachersResponseDto>> GetGradeSubjectsPaged(PaginationParameters parameters);
        Task<PagedResult<GradeSubjectWithTeachersResponseDto>> GetGradeSubjectsByGradeIdPaged(int gradeId, PaginationParameters parameters);
